...
class AssetConstantLogos {
  static const base_path = "assets/logos/";
  static const splash_logo = base_path + "splash-logo.gif";
  static const app_logo = base_path + "app_logo.png";
}
